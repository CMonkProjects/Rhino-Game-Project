...
public class EnemyState_RhinoBoss_Shotgun : EnemyState
{
    ...
    public EnemyState_RhinoBoss_Shotgun(EnemyBehavior_RhinoBoss enemyBehavior) : base(enemyBehavior.gameObject)
    {
    ...
    void DoneShootingWeapon(int _weaponIndex)
    {
        ...
        {
            Debug.LogError("BOSS IS DONE SHOOTING SHOTGUN");
        }
