...
public class EnemyState_RhinoBoss_Blaster : EnemyState
{
    ...
    public EnemyState_RhinoBoss_Blaster(EnemyBehavior_RhinoBoss enemyBehavior) : base(enemyBehavior.gameObject)
    {
    ...
    void DoneShootingWeapon(int _weaponIndex)
    {
        ...
        {
            Debug.LogError("BOSS IS DONE SHOOTING BLASTER");
        }
